  ...
  describe "authenticated" do
    ...
    describe "promote-replica" do
      it "can promote replica server" do
        ...
        replica = instance_double(LanternServer, primary?: false, display_state: "running", id: "pg2", ubid: "pg2", instance_type: "reader", lantern_version: "0.3.0", extras_version: "0.2.5", minor_version: "1", target_vm_size: "n1-standard-2", target_storage_size_gib: 50, max_storage_autoresize_gib: 0, connection_string: "pg://", vm: instance_double(GcpVm, name: "test"))
    ...
    describe "delete-replica" do
      ...
      it "cannot delete primary server" do
        ...
        expect(Project).to receive(:from_ubid).and_return(project).at_least(:once)
        allow(project).to receive(:lantern_resources_dataset).and_return(query_res)
        serv = instance_double(LanternServer, display_state: "running", id: "pg2", ubid: "pg2", instance_type: "writer", lantern_version: "0.3.0", extras_version: "0.2.5", minor_version: "1", target_vm_size: "n1-standard-2", target_storage_size_gib: 50, max_storage_autoresize_gib: 0, connection_string: "pg://", vm: instance_double(GcpVm, name: "test"))
