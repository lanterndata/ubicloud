  ...
  describe "authenticated" do
    ...
    describe "list" do
      ...
      it "creates new lantern database" do
        post "/api/project/#{project.ubid}/location/#{pg.location}/lantern", {"size": "standard-2", "name": "instance-2", "org_id": 0, "location": "us-central1", "storage_size_gib": 100, "lantern_version": "0.2.2", "extras_version": "0.1.4", "minor_version": "1", "domain": "test.db.lantern.dev", "app_env": "test", "repl_password": "test-repl-pass", "enable_telemetry": true, "postgres_password": "test-pg-pass"}
      ...
      it "updates lantern extension" do
        post "/api/project/#{project.ubid}/location/#{pg.location}/lantern/instance-1/update-extension", {"lantern_version": "0.2.3"}
        expect(last_response.status).to eq(200)
      end

      it "updates extras extension" do
        post "/api/project/#{project.ubid}/location/#{pg.location}/lantern/instance-1/update-extension", {"extras_version": "0.2.3"}
        expect(last_response.status).to eq(200)
      end

      it "updates image" do
        post "/api/project/#{project.ubid}/location/#{pg.location}/lantern/instance-1/update-extension", {"lantern_version": "0.2.3", "extras_version": "0.2.3", "minor_version": "1"}
        expect(last_response.status).to eq(200)
      end
    end
  end
