  ...
  describe "#validate_name" do
    ...
    describe "#validate_provider" do
      it "valid provider" do
        expect(described_class.validate_provider("gcp")).to be_nil
      end
    ...
    describe "#validate_org_id" do
      it "valid org id" do
        expect(described_class.validate_org_id(100)).to be_nil
      end

      it "invalid org_id" do
        expect { described_class.validate_org_id("standard-3") }.to raise_error described_class::ValidationFailed
      end
    end

    describe "#validate_version" do
      it "valid version" do
        expect(described_class.validate_version("0.0.1", "test")).to be_nil
      end

      it "invalid version" do
        expect { described_class.validate_version("", "test") }.to raise_error described_class::ValidationFailed
      end
    end
    ...
    describe "#validate_pg_version" do
      it "valid version" do
        ...
        expect(described_class.validate_pg_version("")).to be(Config.pg_default_version)
        expect(described_class.validate_pg_version(nil)).to be(Config.pg_default_version)
      end

      it "invalid version" do
        expect { described_class.validate_pg_version("as") }.to raise_error described_class::ValidationFailed
        expect { described_class.validate_pg_version("14") }.to raise_error described_class::ValidationFailed
      end
    end
    ...
    describe "#validate_postgres_superuser_password" do
      ...
      it "invalid password" do
        ...
        expect { described_class.validate_postgres_superuser_password("short") }.to raise_error(described_class::ValidationFailed)
      end
    end
